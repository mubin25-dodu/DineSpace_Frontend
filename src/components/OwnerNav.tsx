...
export default function OwnerNav({ handleDefaultResturant , socConnect}: OwnerNavProps) {
    ...
    <div className="fixed left-0 top-0 z-50 flex h-full min-w-50 w-[14%] flex-col items-start gap-2 border-r-2 border-[#DEC0BA] bg-[#F5F3F0] p-7 font-semibold text-[#646468]" >
